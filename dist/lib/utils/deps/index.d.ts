...
import { getMajor, getMinor, readPackageJson, runCommand } from "./manageUtils.js";
import { fetchOutdated, displayOutdatedPackages } from "./outdatedUtils.js";
export { collectDepSizes, getDependencies, fixZeroSizesWithFallback, renderDeps, exportResults, getMajor, getMinor, readPackageJson, runCommand, fetchOutdated, displayOutdatedPackages, };
