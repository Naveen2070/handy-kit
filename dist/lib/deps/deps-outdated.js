 ...
 */
export async function handleOutdatedDepsCommand(_, flags) {
    ...
    if (majorOnly === "true" || majorOnly === true) {
        outdated = Object.fromEntries(Object.entries(outdated).filter(([_, info]) => {
...
//# sourceMappingURL=deps-outdated.js.map